...
public OnPlayerCommandText(playerid, cmdtext[])
{
    ...
    {
        new crc[16];
        if (FILE_GetCRC32("scriptfiles/test.bin", crc, sizeof(crc)))
        {
            new msg[96];
    ...
    {
        new result = FILE_VerifyCRC32("scriptfiles/test.bin", "DEADBEEF");
        new msg[96];
    ...
    {
        new result = FILE_Compare("scriptfiles/a.bin", "scriptfiles/b.bin");
        new msg[96];
